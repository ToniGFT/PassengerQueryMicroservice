package com.workshop.passenger.infraestructure.configuration.kafka;
...
public class KafkaConsumerConfig {
    ...
    @Value("${kafka.topics.passenger-events}")
    private String passengerEventsTopic;
    ...
    public void logConfig() {
        ...
        logger.info("Kafka Consumer Config - Topic: {}", passengerEventsTopic);
    }
    ...
    public ReceiverOptions<String, String> receiverOptions() {
        ...
        return ReceiverOptions.<String, String>create(consumerProps)
                .subscription(List.of(passengerEventsTopic));
    }
}
